...
\restrict xuEG54L3KD9xYpehs9FFzrX6x9kXaRw25f9IGG4LWxaU3qvGfhFnNUb0wXabVed
...
--
-- Name: responsavel_fiscal_enum; Type: TYPE; Schema: public; Owner: postgres
--

CREATE TYPE public.responsavel_fiscal_enum AS ENUM (
    'Carla',
    'Denise',
    'Fernando'
);
...
ALTER TYPE public.responsavel_fiscal_enum OWNER TO postgres;
...
--
-- Name: clean_status_label(text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.clean_status_label(src text) RETURNS text
  ...
  -- trim de pontuaÔÇí├åo/traÔÇíos/espaÔÇíos
  t3 AS (
    SELECT btrim(s, ' .--,;-') AS s
    FROM t2
  )
...
ALTER FUNCTION public.clean_status_label(src text) OWNER TO postgres;

--
-- Name: extract_first_br_date(text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.extract_first_br_date(src text) RETURNS date
...
ALTER FUNCTION public.extract_first_br_date(src text) OWNER TO postgres;
...
--
-- Name: trg_licencas_fill_validade(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.trg_licencas_fill_validade() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION public.trg_licencas_fill_validade() OWNER TO postgres;
...
--
-- Name: cnds; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.cnds (
    id integer NOT NULL,
    org_id uuid NOT NULL,
    empresa_id integer NOT NULL,
    esfera character varying NOT NULL,
...
ALTER TABLE public.cnds OWNER TO postgres;

--
-- Name: cnds_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.cnds_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER SEQUENCE public.cnds_id_seq OWNER TO postgres;

--
-- Name: cnds_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.cnds_id_seq OWNED BY public.cnds.id;
...
CREATE TABLE public.empresas (
    ...
    responsavel_fiscal public.responsavel_fiscal_enum,
...
--
-- Name: empresas_backup_categoria; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.empresas_backup_categoria (
    id integer,
...
ALTER TABLE public.empresas_backup_categoria OWNER TO postgres;
...
--
-- Name: v_contatos_uteis; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.v_contatos_uteis AS
 SELECT id,
    contato AS nome,
    email,
    telefone,
...
ALTER VIEW public.v_contatos_uteis OWNER TO postgres;
...
--
-- Name: v_licencas_api; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.v_licencas_api AS
...
ALTER VIEW public.v_licencas_api OWNER TO postgres;
...
--
-- Name: v_modelos_uteis; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.v_modelos_uteis AS
 SELECT id,
    modelo AS titulo,
...
ALTER VIEW public.v_modelos_uteis OWNER TO postgres;
...
--
-- Name: v_taxas_tpi; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.v_taxas_tpi AS
 SELECT t.id,
    e.empresa,
    e.cnpj,
    t.status,
...
ALTER VIEW public.v_taxas_tpi OWNER TO postgres;
...
--
-- Name: cnds id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.cnds ALTER COLUMN id SET DEFAULT nextval('public.cnds_id_seq'::regclass);
...
--
-- Name: cnds cnds_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.cnds
    ADD CONSTRAINT cnds_pkey PRIMARY KEY (id);
...
--
-- Name: idx_cnds_org_empresa; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_cnds_org_empresa ON public.cnds USING btree (org_id, empresa_id);
...
--
-- Name: idx_contatos_org_cat; Type: INDEX; Schema: public; Owner: econtrole
--

CREATE INDEX idx_contatos_org_cat ON public.contatos USING btree (org_id, categoria);


--
-- Name: idx_contatos_org_email; Type: INDEX; Schema: public; Owner: econtrole
--

CREATE INDEX idx_contatos_org_email ON public.contatos USING btree (org_id, lower((email)::text));


--
-- Name: idx_contatos_org_nome; Type: INDEX; Schema: public; Owner: econtrole
--

CREATE INDEX idx_contatos_org_nome ON public.contatos USING btree (org_id, lower(public.immutable_unaccent((contato)::text)));
...
--
-- Name: idx_empresas_org_municipio; Type: INDEX; Schema: public; Owner: econtrole
--

CREATE INDEX idx_empresas_org_municipio ON public.empresas USING btree (org_id, municipio);
...
--
-- Name: idx_licencas_org_empresa_tipo; Type: INDEX; Schema: public; Owner: econtrole
--

CREATE INDEX idx_licencas_org_empresa_tipo ON public.licencas USING btree (org_id, empresa_id, tipo);


--
-- Name: idx_licencas_org_status_validade; Type: INDEX; Schema: public; Owner: econtrole
--

CREATE INDEX idx_licencas_org_status_validade ON public.licencas USING btree (org_id, status, validade);
...
--
-- Name: idx_modelos_org_titulo; Type: INDEX; Schema: public; Owner: econtrole
--

CREATE INDEX idx_modelos_org_titulo ON public.modelos USING btree (org_id, lower(public.immutable_unaccent(modelo)));


--
-- Name: idx_modelos_org_utilizacao; Type: INDEX; Schema: public; Owner: econtrole
--

CREATE INDEX idx_modelos_org_utilizacao ON public.modelos USING btree (org_id, utilizacao);
...
--
-- Name: idx_processos_org_empresa_tipo; Type: INDEX; Schema: public; Owner: econtrole
--

CREATE INDEX idx_processos_org_empresa_tipo ON public.processos USING btree (org_id, empresa_id, tipo);


--
-- Name: idx_processos_org_situacao_prazo; Type: INDEX; Schema: public; Owner: econtrole
--

CREATE INDEX idx_processos_org_situacao_prazo ON public.processos USING btree (org_id, situacao, prazo);
...
--
-- Name: idx_taxas_org_empresa_tipo; Type: INDEX; Schema: public; Owner: econtrole
--

CREATE INDEX idx_taxas_org_empresa_tipo ON public.taxas USING btree (org_id, empresa_id, tipo);


--
-- Name: idx_taxas_org_status_envio; Type: INDEX; Schema: public; Owner: econtrole
--

CREATE INDEX idx_taxas_org_status_envio ON public.taxas USING btree (org_id, status, data_envio);


--
-- Name: idx_taxas_org_venc_tpi; Type: INDEX; Schema: public; Owner: econtrole
--

CREATE INDEX idx_taxas_org_venc_tpi ON public.taxas USING btree (org_id, vencimento_tpi);
...
--
-- Name: ix_empresas_org_id; Type: INDEX; Schema: public; Owner: econtrole
--

CREATE INDEX ix_empresas_org_id ON public.empresas USING btree (org_id);
...
--
-- Name: uq_users_org_email; Type: INDEX; Schema: public; Owner: econtrole
--

CREATE UNIQUE INDEX uq_users_org_email ON public.users USING btree (org_id, email);


--
-- Name: licencas licencas_fill_validade_biur; Type: TRIGGER; Schema: public; Owner: econtrole
--

CREATE TRIGGER licencas_fill_validade_biur BEFORE INSERT OR UPDATE ON public.licencas FOR EACH ROW EXECUTE FUNCTION public.trg_licencas_fill_validade();


--
-- Name: contatos tg_upd_contatos; Type: TRIGGER; Schema: public; Owner: econtrole
--

CREATE TRIGGER tg_upd_contatos BEFORE UPDATE ON public.contatos FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: modelos tg_upd_modelos; Type: TRIGGER; Schema: public; Owner: econtrole
--

CREATE TRIGGER tg_upd_modelos BEFORE UPDATE ON public.modelos FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: empresas trg_empresas_updated_at; Type: TRIGGER; Schema: public; Owner: econtrole
--
...
--
-- Name: licencas trg_licencas_updated_at; Type: TRIGGER; Schema: public; Owner: econtrole
--

CREATE TRIGGER trg_licencas_updated_at BEFORE UPDATE ON public.licencas FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: processos trg_processos_updated_at; Type: TRIGGER; Schema: public; Owner: econtrole
--
...
--
-- Name: taxas trg_taxas_updated_at; Type: TRIGGER; Schema: public; Owner: econtrole
--

CREATE TRIGGER trg_taxas_updated_at BEFORE UPDATE ON public.taxas FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();
...
--
-- Name: cnds cnds_empresa_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.cnds
    ADD CONSTRAINT cnds_empresa_id_fkey FOREIGN KEY (empresa_id) REFERENCES public.empresas(id);


--
-- Name: cnds cnds_org_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.cnds
    ADD CONSTRAINT cnds_org_id_fkey FOREIGN KEY (org_id) REFERENCES public.orgs(id);


--
-- Name: empresas empresas_created_by_fk; Type: FK CONSTRAINT; Schema: public; Owner: econtrole
--

ALTER TABLE ONLY public.empresas
    ADD CONSTRAINT empresas_created_by_fk FOREIGN KEY (created_by) REFERENCES public.users(id);


--
-- Name: empresas empresas_updated_by_fk; Type: FK CONSTRAINT; Schema: public; Owner: econtrole
--

ALTER TABLE ONLY public.empresas
    ADD CONSTRAINT empresas_updated_by_fk FOREIGN KEY (updated_by) REFERENCES public.users(id);


--
-- Name: agendamentos fk_agendamentos_org; Type: FK CONSTRAINT; Schema: public; Owner: econtrole
--

ALTER TABLE ONLY public.agendamentos
    ADD CONSTRAINT fk_agendamentos_org FOREIGN KEY (org_id) REFERENCES public.orgs(id) ON DELETE CASCADE;


--
-- Name: contatos fk_contatos_org; Type: FK CONSTRAINT; Schema: public; Owner: econtrole
--

ALTER TABLE ONLY public.contatos
    ADD CONSTRAINT fk_contatos_org FOREIGN KEY (org_id) REFERENCES public.orgs(id) ON DELETE CASCADE;
...
--
-- Name: modelos fk_modelos_org; Type: FK CONSTRAINT; Schema: public; Owner: econtrole
--

ALTER TABLE ONLY public.modelos
    ADD CONSTRAINT fk_modelos_org FOREIGN KEY (org_id) REFERENCES public.orgs(id) ON DELETE CASCADE;
...
--
-- Name: licencas licencas_created_by_fk; Type: FK CONSTRAINT; Schema: public; Owner: econtrole
--

ALTER TABLE ONLY public.licencas
    ADD CONSTRAINT licencas_created_by_fk FOREIGN KEY (created_by) REFERENCES public.users(id);
...
--
-- Name: licencas licencas_updated_by_fk; Type: FK CONSTRAINT; Schema: public; Owner: econtrole
--

ALTER TABLE ONLY public.licencas
    ADD CONSTRAINT licencas_updated_by_fk FOREIGN KEY (updated_by) REFERENCES public.users(id);


--
-- Name: processos processos_created_by_fk; Type: FK CONSTRAINT; Schema: public; Owner: econtrole
--

ALTER TABLE ONLY public.processos
    ADD CONSTRAINT processos_created_by_fk FOREIGN KEY (created_by) REFERENCES public.users(id);
...
--
-- Name: processos processos_updated_by_fk; Type: FK CONSTRAINT; Schema: public; Owner: econtrole
--

ALTER TABLE ONLY public.processos
    ADD CONSTRAINT processos_updated_by_fk FOREIGN KEY (updated_by) REFERENCES public.users(id);


--
-- Name: taxas taxas_created_by_fk; Type: FK CONSTRAINT; Schema: public; Owner: econtrole
--

ALTER TABLE ONLY public.taxas
    ADD CONSTRAINT taxas_created_by_fk FOREIGN KEY (created_by) REFERENCES public.users(id);
...
--
-- Name: taxas taxas_updated_by_fk; Type: FK CONSTRAINT; Schema: public; Owner: econtrole
--

ALTER TABLE ONLY public.taxas
    ADD CONSTRAINT taxas_updated_by_fk FOREIGN KEY (updated_by) REFERENCES public.users(id);
...
GRANT USAGE ON SCHEMA public TO econtrole;


--
-- Name: FUNCTION clean_status_label(src text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.clean_status_label(src text) TO econtrole;


--
-- Name: TABLE v_licencas_api; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.v_licencas_api TO econtrole;
...
ALTER DEFAULT PRIVILEGES FOR ROLE postgres IN SCHEMA public GRANT ALL ON FUNCTIONS TO econtrole;
...
\unrestrict xuEG54L3KD9xYpehs9FFzrX6x9kXaRw25f9IGG4LWxaU3qvGfhFnNUb0wXabVed
